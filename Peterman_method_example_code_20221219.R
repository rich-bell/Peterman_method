...
dim(boca)
 boca<-boca[-c(63:64),]	#	rec dev 1954-2015

write.table( boca[,c(1:3,6,8,13)],'C:/Users/rich.bell.TNC/projects/NA/work_business_plans/Packard/climate_ready_fisheries/stock_productivity/R_cran/West_coast_stocks/bocaccio_2017.csv',sep=',',row.names=F)
